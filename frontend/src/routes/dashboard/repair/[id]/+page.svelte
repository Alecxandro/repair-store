<script>
    ...
    async function fetchRepairDetails() {
        try {
            ...
            editedRepair = { ...repair }; // Create a copy for editing
        } catch (err) {
    ...
    async function deleteRepair() {
        try {
            ...
            const token = getToken();
            await axios.delete(
                `${API_BASE_URL}/api/repair/repair/delete-repair/${repair._id}`, 
                {
                    headers: { 
                        Authorization: `Bearer ${token}`
                    }
            ...
            // Redirect to repairs list after successful deletion
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input 
                                        class="input" 
                                        type="date" 
                                        bind:value={editedRepair.completionDate}
                                    >
                                </div>
                            </div>
    ...
    <div class="modal is-active">
        ...
        <div class="modal-card">
            <header class="modal-card-head">
                ...
                <button class="delete" aria-label="close" on:click={() => showDeleteConfirmModal = false}></button>
            </header>
